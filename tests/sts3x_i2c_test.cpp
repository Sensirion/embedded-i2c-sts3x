...
TEST (STS3X_Tests, test_measure_single_shot_high_repeatability1) {
    ...
    local_error =
        sts3x_measure_single_shot_high_repeatability(&temperature_ticks);
...
TEST (STS3X_Tests,
    ...
    int16_t local_error = 0;
    uint16_t temperature_ticks = 0;
    local_error = sts3x_measure_single_shot_high_repeatability_clock_stretching(
        &temperature_ticks);
...
TEST (STS3X_Tests, test_measure_single_shot_medium_repeatability1) {
    int16_t local_error = 0;
    uint16_t temperature_ticks = 0;
    local_error =
...
TEST (STS3X_Tests, test_measure_single_shot_low_repeatability1) {
    int16_t local_error = 0;
    uint16_t temperature_ticks = 0;
    local_error =
        sts3x_measure_single_shot_low_repeatability(&temperature_ticks);
...
TEST (STS3X_Tests,
    ...
    int16_t local_error = 0;
    uint16_t temperature_ticks = 0;
    local_error = sts3x_measure_single_shot_low_repeatability_clock_stretching(
        &temperature_ticks);
    CHECK_EQUAL_ZERO_TEXT(
...
TEST (STS3X_Tests, test_read_status_register1) {
    int16_t local_error = 0;
    uint16_t a_status_register = 0u;
    local_error = sts3x_read_status_register(&a_status_register);
    CHECK_EQUAL_ZERO_TEXT(local_error, "read_status_register");
    printf("a_status_register: %02x\n", a_status_register);
}

TEST (STS3X_Tests, test_clear_status_register1) {
    int16_t local_error = 0;
    local_error = sts3x_clear_status_register();
    CHECK_EQUAL_ZERO_TEXT(local_error, "clear_status_register");
}

TEST (STS3X_Tests, test_stop_measurement1) {
    int16_t local_error = 0;
    local_error = sts3x_stop_measurement();
    CHECK_EQUAL_ZERO_TEXT(local_error, "stop_measurement");
}

TEST (STS3X_Tests, test_soft_reset1) {
    int16_t local_error = 0;
    local_error = sts3x_soft_reset();
