# Sensirion I2C STS3X embedded Library

This document explains how to set up a sensor of the STS3X family to run on an embedded device using the I²C interface.
...
5. Run the compiled executable with `./sts3x_i2c_example_usage`
...
5. Run the compiled executable with `./sts3x_test_hw_i2c`.
